"""MCP (Model Context Protocol) server for AgentMemory.

Exposes AgentMemory as tools that any MCP-compatible agent can call.
...
mcp = FastMCP(
    "agentmemory",
    instructions=(
        "AgentMemory MCP server — tools for persistent cross-agent memory. "
